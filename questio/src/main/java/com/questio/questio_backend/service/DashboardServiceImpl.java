...
import com.questio.questio_backend.entity.enums.TipoUsuario; // Garanta que este import está correto
...
public class DashboardServiceImpl implements DashboardService {
    ...
    public DashboardResumoDTO obterResumoGeral() {
        long alunos = userRepository.countByTipoUsuario("Aluno");
        long professores = userRepository.countByTipoUsuario("Professor");
